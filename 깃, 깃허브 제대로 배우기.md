...
## 1. 최초 설정 (Initial Setup)
Git을 처음 설치하고 나서 한 번만 설정하면 됩니다.
...
```
### 3. Git의 3가지 작업 공간
Git은 다음 3가지 공간을 통해 버전을 관리합니다.

· Working Directory (작업 디렉토리)

현재 내가 작업하고 있는 실제 파일들이 있는 공간입니다.

· Staging Area (스테이징 영역)

다음 커밋(버전)에 포함시킬 파일들을 미리 모아두는 임시 공간입니다.

· Repository (.git directory)
프로젝트의 모든 변경 이력(커밋들)이 영구적으로 저장되는 공간입니다.
